...
public class BackupMain {
    ...
    private BackupMain(String url, String username, String password, String targetVm) {
    ...
    private void uploadArchiveFile(VirtualBox virtualBox) {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            backupMain = new BackupMain(url, username, password, vm);
